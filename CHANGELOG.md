...
### Changed
- Enhanced most tools to support batch operations for improved efficiency
  - All tools require array parameters, even for single operations
  - Fully self-contained objects: each operation includes all necessary parameters
  - Sequential processing ensures proper parent-child dependencies
  - Preserved smart positioning logic for card creation/update operations
...
[0.4.0]: https://github.com/steveclarke/mcp-superthread-plus/releases/tag/v0.4.0
